...
$(document).ready(function(){
	...
	if( $('#chart_candidates').length > 0 ){
		var ctx1 = document.getElementById("chart_candidates").getContext("2d");
		var data1 = {
			labels: ["Vincent Tumaini", "Audetta Kumwenda", "Vitumbiko Chavula", "Blessings Vinkhumbo", "Tapiwa Kasambara", "Eve Bokosi", "Elizabeth Nyirenda", "Arnold Zulu"],
			datasets: [
			{
				label: "Vote Count",
				...
				pointBorderColor: "rgb(60,184,120)",
				pointHighlightStroke: "rgba(60,184,120,1)",
				data: [34, 1859, 2183, 484, 200, 3509, 43, 28]
			},
