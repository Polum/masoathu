    ...
    <!-- Top Menu Items -->
        ...
        <div class="fixed-sidebar-left">
            <ul class="nav navbar-nav side-nav nicescroll-bar">
                ...
                <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#results_dr">
                        <i class="icon-note  mr-10"></i>Results<span class="pull-right">
                        <i class="fa fa-fw fa-angle-down"></i></span></a>

                    <ul id="results_dr" class="collapse collapse-level-1">
                        <li>
                            <a href="{{url('presidential-results')}}"><i class="icon-picture mr-10"></i>Presidential Results</a>
                        </li>
                        <li>
                            <a href="{{url('add-results')}}"><i class="icon-note  mr-10"></i>Add Presidential Result</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#reports_dr">
                        <i class="icon-note  mr-10"></i>Reports<span class="pull-right">
                        <i class="fa fa-fw fa-angle-down"></i></span></a>

                    <ul id="reports_dr" class="collapse collapse-level-1">
                        <li>
                            <a href="{{url('response-reports')}}"><i class="icon-picture mr-10"></i>Response Reports</a>
                        </li>
                    </ul>
                </li>
