    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Question List</h6>
                        </div>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form class="form-inline" action=" {{ url('import-all-Question') }}" method="post"
                                    ...
                                    <button type="submit"
                                        ...
                                        <span>Upload Question List</span></button>
                                </form>
                            </div>
        ...
        @section('scripts')
            <script type="application/javascript">
                var questionListUrl = "{{ url('question-resources') }}";
            ...
            <script src="vendors/custom_js/questions.js"></script>
