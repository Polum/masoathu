...
<div class="container-fluid">
				...
				<div class="row heading-bg bg-green">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-light">Open Messages</h5>
					</div>
					<!-- Breadcrumb -->
				...
				<div class="row">
										...
										<div class="row">
											...
											<div class="col-xs-6">
												<div class="counter-wrap text-right">
													<span class="counter count-block">125</span>
												</div>	
											</div>
										</div>
									</div>
								...
								<div class="panel-body">
									<div class="sm-graph-box">
										<div class="row">
											...
											<div class="col-xs-6">
												<div class="counter-wrap text-right">
													<span class="counter count-block">10</span>
												</div>	
											</div>
										</div>
									</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">	
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Web - https://masoathu.com</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="sm-graph-box">
										<div class="row">
											<div class="col-xs-6">
												<img src="dist/img/web.png" alt="sms icon" class="img-responsive" />
											</div>
											<div class="col-xs-6">
												<div class="counter-wrap text-right">
													<span class="counter count-block">3</span>
												</div>	
											</div>
										</div>
									</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">	
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Twitter</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="sm-graph-box">
										<div class="row">
											<div class="col-xs-6">
												<img src="dist/img/twitter.png" alt="sms icon" class="img-responsive" />
											</div>
											<div class="col-xs-6">
												<div class="counter-wrap text-right">
													<span class="counter count-block">1122</span>
												</div>	
											</div>
										</div>
									</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Open Messages</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												@for($x = 0; $x <= 10; $x++)
													<tr>
														...
														<td>Form 34B from Nambale Constituency Received at Bomas..</td>
														<td>11:00 on Oct 27</td>
														<td>13.90008</td>
														<td>-33.75689</td>
