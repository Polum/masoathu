            ...
            <div class="row">
                <div class="col-md-12 mb-15">
                    <div class="btn-group btn-group-justified">
                        <a class="btn btn-warning" role="button" href="{{ url('/observer_response') }}">Morning Timeline (6:00am - 10:00am)</a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark"><i class="icon-plus mr-10"></i>
                                Time polling stations opened</h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="panel-wrapper collapse in">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark"><i class="icon-pie-chart mr-10"></i>Long queues at Polling Station
                                    </h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark"><i class="icon-plus mr-10"></i>Voting resources</h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="panel-wrapper collapse in">
...
@section('scripts')
    <script type="application/javascript">
        ...
        var vr = dashboardData.voting_resources;
        var pr = dashboardData.party_representatives;
        var incidences = dashboardData.incidences;
        var regCenterData;
    ...
    <script src="vendors/custom_js/electionday/morning.js"></script>
