            ...
            <div class="row">
                <div class="col-md-12 mb-15">
                    <div class="btn-group btn-group-justified">
                        ...
                        <a class="btn btn-default btn-outline" role="button" href="{{ url('/afternoon') }}">Afternoon Timeline (10:01am - 2:00pm)</a>
                        <a class="btn btn-warning" role="button" href="{{ url('/evening') }}">Evening Timeline (2:01pm - 6:00pm)</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark"><i class="icon-plus mr-10"></i>
                                    Ballot papers counted at the polling station. </h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div id="ballot_paper_counted_at_station" style="height: 190px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark"><i class="icon-plus mr-10"></i>
                                    Adequate lighting during ballot counting. </h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div id="adequate_lighting" style="height: 190px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark"><i class="icon-plus mr-10"></i>
                                    Ballot boxes were transported somewhere else for counting. </h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div id="ballot_boxes_transported_offsite" style="height: 190px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default card-view">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div id="ballot_paper_supply" style="height: 300px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script src="vendors/custom_js/electionday/evening.js"></script>
