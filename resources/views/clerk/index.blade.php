        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Incident Reports</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
...
@section('scripts')
    <script type="application/javascript">
        ...
        var observer_responses = "{{ url('responses') }}";
        var flag_message = "{{ url('flag-message') }}";
        var udate_message = "{{ url('update-message') }}";
        var observerUrl = "{{ url('observer-resources') }}";
        var regCenterUrl = "{{ url('polling-station-resources') }}";
        var questionSetUrl = "{{ url('observer-questions') }}";
    ...
    <!--<script src="vendors/custom_js/centres.js"></script>-->
