                            ...
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table class="table table-hover display  pb-30">
                                        ...
                                        <tbody class="sms-text-list" id="observers">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script>
        $(function(){
            ...
            $.get(dosile, function(data){
                $('#observers').html('');
                let tableRow = '';
                $.each(data, (key, value)=>{
                    tableRow += '<tr><td>'+value.first_name+' '+value.last_name+'</td><td>'+value.phone_number+'</td></tr>';
                });
                $('#observers').html(tableRow);
            });
