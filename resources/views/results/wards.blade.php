        ...
        <div class="row heading-bg bg-yellow">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Wards</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
        ...
        <div class="row">
            <div class="col-md-12 mb-15">
                <div class="btn-group btn-group-justified">
                    ...
                    <a class="btn btn-warning" role="button" href="{{ url('/wards') }}">Wards</a>
                ...
                <div class="panel panel-default card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body padding">
                            <table id="wards_table" class="table table-sm">
                                <thead>
                                    <tr>
                                        <th scope="col">NO.</th>
        ...
        function ds(link){
            link = link || "{{ url('/api/wards') }}";
             ...
             $.get(link,(data, status)=>{
                ...
                total.append('TOTAL WARDS = '+data.meta.total);
                //get
                $('#wards_table tbody').html('');
                $.each(data.data, function(index, value){
                    $('#wards_table tbody').append(`
                    <tr>
                        ...
                        <td>`+value.centres+`</td> 
                        <td> <a href='{{ url("ward/`+value.id+`") }}' type="button" class="btn btn-primary btn-sm">View Ward</a></td>
                    </tr> 
                    `);
                });
            });
