...
@section('content')
    <div class="container-fluid">
        ...
        <h3 class="text-center">CONSTITUENCIES</h3>
        <div class="row">
            <div class="col-md-12 mb-15">
                <div class="btn-group btn-group-justified">
                    ...
                    <a class="btn btn-warning" role="button" href="{{ url('/constituencies') }}">Constituencies</a>
                ...
                <div class="panel panel-default card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body padding">
                            <table id="constituencies_table" class="table table-sm">
                                <thead>
                                    <tr>
                                        <th scope="col">NO.</th>
...
@section('scripts')
    ...
    <script> 
        ...
        function ds(link){
            link = link || "{{ url('/api/constituencies') }}";
             ...
             $.get(link,(data, status)=>{
                ...
                total.append('TOTAL CONSTITUENCIES = '+data.meta.total);
                //get
                $('#constituencies_table tbody').html('');
                $.each(data.data, function(index, value){
                    $('#constituencies_table tbody').append(`
                    <tr>
                        ...
                        <td>`+value.wards+`</td>
                        <td>`+value.centres+`</td> 
                        <td> <a href='{{ url("constituency/`+value.id+`") }}' type="button" class="btn btn-primary btn-sm">View Constituency</a></td>
                    </tr> 
                    `);
                });
            });
