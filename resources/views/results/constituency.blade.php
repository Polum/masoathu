        ...
        <div class="row heading-bg bg-yellow">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Constituency</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark"><i class="icon-plus mr-10"></i>
                            <span class="pg_title"></span> Wards </h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
                                ...
                                <tbody> 
                                    ...
                                    @foreach($constituency["wards"] as $ward)
                                        <tr>
                                            ...
                                            <td>{{ $ward["ward_name"] }}</td>
                                            <td>{{ $ward["centres"] }}</td>
                                            <td><a class="btn btn-primary" role="button" href="{{ url('/ward/'.$ward["ward_id"]) }}">View Ward</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>       
                            </table>
...
@section('scripts')
    ...
    <script>
        var link = "{{ url('/api/constituency/'.$constituency['id']) }}";
        var page = "constituency";
    </script>
